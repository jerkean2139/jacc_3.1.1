 ...
 */
export function analyzePromptInjection(input: string): InjectionAnalysis {
 ...
 */
function sanitizeInput(input: string, isHighRisk: boolean): string {
  if (!isHighRisk) {
 ...
 */
function generateRecommendations(riskLevel: string, patterns: string[]): string[] {
