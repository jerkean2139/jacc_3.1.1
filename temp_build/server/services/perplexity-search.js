export class PerplexitySearchService {
    ...
    async searchIndustryIntelligence(query) {
        try {
    ...
    enhanceQueryForIndustry(query) {
        ...
        const hasIndustryContext = industryKeywords.some(keyword => queryLower.includes(keyword.toLowerCase()));
    ...
    async searchCompetitorAnalysis(processorName) {
    ...
    async searchPricingIntelligence(query) {
